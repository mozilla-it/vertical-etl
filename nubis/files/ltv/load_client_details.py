...
"""S3 to Vertica ETL : LTV load client details
"""
...
def main():
    ...
    vertica_table_name = 'ut_clients_daily_details'
    ...
    last_updated_sql = ("insert into last_updated values ('ut_clients_daily_details', now(), 'Cron-Loader'); COMMIT;")
